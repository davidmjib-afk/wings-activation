              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {segClients.map((c, i) => {
                    ...
                    return (
                      <tr key={c.id} className={`border-b border-gray-50 hover:bg-orange-50 cursor-pointer transition-colors ${isAtRisk ? 'bg-red-50/30' : ''}`} onClick={() => router.push(`/client/${c.id}`)}>
